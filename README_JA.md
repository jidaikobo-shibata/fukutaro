...
1. ***Pause Duration***: 音声解説を始める前に動画を停止する秒数です（例: `5`）。重要な映像内容に音声解説が重ならないようにするために使えます。[1.2.7 Extended Audio Description (Prerecorded) (AAA)](https://www.w3.org/WAI/WCAG22/Understanding/extended-audio-description-prerecorded.html) への対応でも有効です。
